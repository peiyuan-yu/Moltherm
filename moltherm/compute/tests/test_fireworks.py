...
from moltherm.compute.fireworks import (OptFreqSPFW, FrequencyFlatteningOptimizeFW, SinglePointFW,
                                        FrequencyFW, FrequencyFlatteningTransitionStateFW,
                                        RunQChemCustodian, WriteCustomInput)
...
class TestFrequencyFlatteningTransitionStateFW(AtomateTest):
        ...
        self.assertEqual(firework.tasks[2].as_dict(),
                         QChemToDb(
                             ...
                             additional_fields={"special_run_type":
                                                ...
                                                "task_label":
                                                    "frequency flattening transition state optimization"}).as_dict())
        self.assertEqual(firework.parents, [])
        self.assertEqual(firework.name,
    ...
    def test_FrequencyFlatteningTransitionStateFW_not_defaults(self):
        firework = FrequencyFlatteningTransitionStateFW(
            molecule=self.act_mol,
            name="special frequency-flattening FSM_TS",
            qchem_cmd="qchem -slurm",
            multimode="mpi",
            max_cores=12,
            qchem_input_params={"pcm_dielectric": 10.0},
        ...
        self.assertEqual(
            ...
            QChemToDb(
                ...
                additional_fields={
                    "task_label":
                        "special frequency-flattening FSM_TS",
                    "special_run_type":
                        "ts_frequency_flattener"
                }).as_dict())
        self.assertEqual(firework.parents, [])
...
class TestFrequencyFW(AtomateTest):
    ...
    def setUp(self):
        ...
        qc_out = QCOutput(filename=out_file)
        self.act_mol = qc_out.data["initial_molecule"]
        super(TestFrequencyFW, self).setUp(lpad=False)
    ...
    def test_FrequencyFW_defaults(self):
        ...
        self.assertEqual(firework.tasks[2].as_dict(),
                         QChemToDb(
                             ...
                             input_file="mol.qin",
                             output_file="mol.qout",
                             additional_fields={"task_label": "vibrational analysis"}).as_dict())
        self.assertEqual(firework.parents, [])
        self.assertEqual(firework.name,
    ...
    def test_FrequencyFW_not_defaults(self):
        firework = FrequencyFW(
            molecule=self.act_mol,
            name="special vibrational analysis",
            qchem_cmd="qchem -slurm",
            multimode="mpi",
            max_cores=12,
            qchem_input_params={"pcm_dielectric": 10.0},
...
class TestSinglePointFW(AtomateTest):
    ...
    def test_SinglePointFW_defaults(self):
        ...
        self.assertEqual(firework.tasks[2].as_dict(),
                         QChemToDb(
                             ...
                             input_file="mol.qin",
                             output_file="mol.qout",
                             additional_fields={"task_label": "single point"}).as_dict())
        self.assertEqual(firework.parents, [])
        self.assertEqual(firework.name,
                         "single point")
